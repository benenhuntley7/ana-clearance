...
export default function StoreData() {
  ...
  const sortData = (dataToSort: any) => {
    if (sortOrder === "value") {
      // Sort by SOH@Cost (cost) in descending order
      return [...dataToSort].sort((a, b) => b.cost - a.cost);
    } else if (sortOrder === "age") {
      // Sort by Age (you need to replace 'age' with the actual property representing age)
      return [...dataToSort].sort((a, b) => b.soh - a.soh);
    }
  };
            ...
            <div className="flex justify-center mt-5">
              <form>
                <label>
                  Sort by:
                  <select
                    className="select select-bordered mx-4"
                    onChange={(e) => {
                      setSortOrder(e.target.value);
                    }}
                  >
                    <option value="value">By SOH@Cost</option>
                ...
                <label>
                  Z5:
                  <input className="checkbox" type="checkbox" value="z5" />
                </label>
              </form>
            </div>
